<div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                        ...
                        <div className="inline-flex flex-column gap-2">
                            ...
                            <InputText id="name" label="name" className="bg-white-alpha-20 border-none p-3 text-primary-50"></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="describtion" className="text-primary-50 font-semibold">
                            describtion
                            </label>
                            <InputText id="describtion" label="describtion" className="bg-white-alpha-20 border-none p-3 text-primary-50"></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="code" className="text-primary-50 font-semibold">
                                code
                            </label>
                            <InputText id="code" label="code" className="bg-white-alpha-20 border-none p-3 text-primary-50" type="password"></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="price" className="text-primary-50 font-semibold">
                                price
                            </label>
                            <InputText id="price" label="price" className="bg-white-alpha-20 border-none p-3 text-primary-50" type="password"></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="image" className="text-primary-50 font-semibold">
                                image
                            </label>
                            <InputText id="image" label="image" className="bg-white-alpha-20 border-none p-3 text-primary-50" type="password"></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="imageArr" className="text-primary-50 font-semibold">
                                imageArr
                            </label>
                            <InputText id="imageArr" label="imageArr" className="bg-white-alpha-20 border-none p-3 text-primary-50" type="password"></InputText>
                        </div>
                        <div className="flex align-items-center gap-2">
                            <Button label="Update" onClick={(e) => hide(e)} text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"></Button>
